...
type ContextSignals struct {
	...
	// зависимость = single point of failure). Вердикт соундности: WARNING-сигнал,
	...
	// Coverage — покрытие топ-N PageRank-критических узлов контекстами. Вердикт соундности:
